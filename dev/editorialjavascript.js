let javascript = function (par) {
  // Change the funcion name here (imperative)

  let jsonfile = `https://docs.google.com/spreadsheets/d/17ybrU9i4Z_czj_-5n1gWUBvgicHfwJUyMBqriuA-Ab8/edit#gid=1755588864`; // Change the URL here (imperative)
  ...
  getcsvdata(GoogleSheetCsvURL(jsonfile), function (jsondata) {
      ...
      let code = `<div class="outputgrid"><span class='categoria noline'>PROGRAMAÇÃO PARA DATAVIZ</span><span class='categoria'>&nbsp;</span>`;
